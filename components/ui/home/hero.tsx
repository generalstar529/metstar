    ...
    <section className="home-hero">
      <div className='container mx-auto'>
        <div className="h-full text-center flex justify-center">
          <Image src={imgHomeHeroDesktop} alt='home-hero' className='hidden md:block' layout='fill' style={{ objectFit: 'cover' }} />
          <Image src={imgHomeHero} alt='home-hero' className='md:hidden' layout='fill' style={{ objectFit: 'cover' }} />
          <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl home-hero-title" ref={titleGroupRef}>
