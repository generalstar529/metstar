...
const careers: ICareerItem[] = [
  {
    ...
    contents: [
      "Lineworker", "Foreman", "Project Manger", "Safety Coordinator", "Groundworker", "And Many More...",
    ]
  },
  {
    title: "Energy Efficiency",
    contents: [
      "Project Coordinator", "Project Engineer", "Project Manager", "Welder", "Pipefitter", "And Many More...",
    ]
  },
  {
    title: "Safety",
    contents: [
      "Project Construction Coordinator", "Site Quality Coordinator", "Site Saftey Coordinator", "Solar Installer", "Turbine Installer", "And Many More...",
    ]
  },
  {
    title: "Interior Remodeling",
    contents: [
      "Aerial Lineman", "Fiber Splicer", "Horizontal Directional Drill Locator", "Project Controls Coordinator", "Antenna Array Technician", "And Many More...",
    ]
  },
  {
    title: "Exterior Remodeling",
    contents: [
      "Emergency", "Management Services Manager", "Environmental Civill Engineer", "Helicopter Pilot", "Environmental Compliance Officer", "Procurement Specialist", "And May More...",
    ]
  },
  {
    title: "Restoration",
    contents: [
      "Distribution Planning Engineer", "Substation Planner", "Transmission Engineer", "GIS Specialist", "Surveyor", "And Many More..."
    ]
  },
  {
    title: "Generators",
    contents: [
      "Distribution Planning Engineer", "Project Engineer", "Transmission Engineer", "Environmental Civil Engineer", "GIS Specialist", "And Many More..."
    ]
  }
]
      ...
      <div className='container mx-auto'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-20 bg-zinc-100 py-28 px-11 home-career-content'>
          <div>
            ...
            <Carousel cols={1} rows={1} gap={10} showDots={true} style={{ width: '100%', height: '100%' }} loop>
              <Carousel.Item>
                <Image src={imgEngineer} alt='engineer' style={{ width: '100%', height: '100%' }} ></Image>
              </Carousel.Item>

              <Carousel.Item>
                <Image src={imgWelder} alt='welder' style={{ width: '100%', height: '100%' }} ></Image>
              </Carousel.Item>
            </Carousel>
          </div>
