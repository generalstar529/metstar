...
const news: INewsItem[] = [
  {
    ...
    content:
      "Every year Jobs West honors an employer for fostering a diverse workforce that includes neurodiverse staff members. Allteck is Jobs West’s choice for Employer of the Year in 2021! Jobs West enables people with developmental disabilities to prepare for, find and maintain community-based employment placements.",
  },
  {
    title:
      "Metstar Premier Era Innovations Participates in Human Rights Campaign Corporate Equality Index",
    content:
      "Here at Metstar Premier Era Innovations Services we respect and value our LGBTQ+ employees. We are proud to have participated in the Human Rights Campaign’s Corporate Equality Index to show our allyship to our LGBTQ+ workforce. The Corporate Equality Index is the nation’s foremost benchmarking survey and report measuring corporate policies and practices related to LGBTQ+ workplace equality.",
  },
  {
    title:
      "Shay Bahramirad Named President-Elect of IEEE Power and Energy Society",
    content:
      "Shay Bahramirad of LUMA Energy has been elected to serve on the Governing Board of the Institute of Electrical and Electronics Engineers (IEEE) Power and Energy Society as the President-Elect in 2022 and 2023.",
  },
];
  ...
  return (
    <section className="diversity-newsreport bg-zinc-100">
      <div className="container text-left p-10 w-10/12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="col-span-1 description">
            ...
            <div className="text-sm text-black">
              Metstar Premier Era Innovations and its operating companies are
              actively engaged in diversity and inclusion work. Here are some
              highlights.
            </div>
          </div>
          <div className="col-span-1 md:col-span-2 imagecard">
            <ImageCard
              imageSrc={imgNewsreport}
              title="2021 Year in Review"
              subTitle=""
              description="We engage with diversity and inclusion because it’s meaningful to our people, enhances our work, and helps us grow our business. These are our highlights from the year."
        ...
        <div
          className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 my-10 bg-zinc-100 news-container"
            ...
            <section key={idx} className="tag">
              <div className="flex flex-col h-full px-10 py-2">
                ...
                <AnimatedButton
                  variant="transparent"
                  icon="arrow-right"
                  className="text-black text-left text-md md:text-lg my-12 mt-auto"
                >
                  READ MORE
                </AnimatedButton>
              </div>
