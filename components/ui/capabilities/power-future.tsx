        ...
        <div className="col-span-1 relative">
          ...
          <div className="flex flex-row mt-5">
            ...
            <div className="text-4xl md:text-5xl">
              <div className="text-white mt-10">YOUR BRIGHTER</div>
              <div className="mb-10">
                <span className="text-white">FUTURE STARTS</span>&nbsp;&nbsp;
                <span className="txt-warning">HERE</span>
              </div>
              <div className="text-sm text-white">
                Find your path to a rewarding career in the trades. Get in touch
                with us to discuss the possibilities ahead of you.
              </div>
            </div>
          </div>
        </div>
