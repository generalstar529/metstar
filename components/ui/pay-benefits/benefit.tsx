...
const benefits: IBenefit[] = [
  {
    topic: "Medical",
    description:
      "Metstar Premier Era Innovations offers three medical plans with the same expansive provider network.",
    details: [
      "PPO Plan",
  ...
  },
  {
    topic: "Vision",
    description:
      "Annual benefits include comprehesive exams, eyeglasses or contact lenses and discounts on the following:",
    details: [
      "Laser eye surgery",
  ...
  },
  {
    ...
    description:
      "Providing income protection if you cannot work due to injury or illness.",
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:grid-cols-3 pay-benefits-content p-24">
          {benefits.map((item, idx) => (
            <div
              className={`card px-8 py-4 text-white ${
                idx === benefits.length - 1 ? "col-span-2" : "col-span-1"
              }`}
            >
