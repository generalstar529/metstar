...
const news : INewsItem[] = [
  ...
  {
    title: "Social",
    content: "People are the heart of what we do, and why we do it. We welcome and empower employees from all backgrounds to build successful careers and give back to the communities where we live and work. We know that our company can only succeed if we enhance the lives of our employees and our communities.",
  },
  {
    title: "Governance",
  ...
  return (
    <section className="sustainability-summary bg-zinc-100">
      <div className='container p-1 w-11/12 mx-auto'>
        <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 my-10 news-container' ref={newsContainerRef}>
            {
